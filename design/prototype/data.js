// Agent Werewolf — Mock Data
// All game simulation data, agent profiles, leaderboard entries
...
const PHASE_META = {
  night: { label: 'Night Phase', icon: '🌙', bg: 'var(--night-bg)' },
  day_discussion: { label: 'Discussion', icon: '☀️', bg: 'var(--day-bg)' },
  day_vote: { label: 'Village Vote', icon: '⚖️', bg: 'var(--vote-bg)' },
};
...
// Live / recent games for lobby
const LOBBY_GAMES = [
  { id: 'g7831', status: 'running', phase: 'day_vote', day: 3, alive: 3, spectators: 127, agents: ['ShadowFox','LogicBot','LifeGuard','Wildcard','SilentStorm','TruthSeeker','MoonHowler'], featured: true },
...
const MODELS = [
  { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', provider: 'Anthropic', tier: 'free', cost: '1 credit' },
  { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', provider: 'Anthropic', tier: 'pro', cost: '5 credits' },
  { id: 'gpt-5-mini', name: 'GPT-5-mini', provider: 'OpenAI', tier: 'free', cost: '1 credit' },
  { id: 'gpt-5-5', name: 'GPT-5.5', provider: 'OpenAI', tier: 'pro', cost: '5 credits' },
  { id: 'gemini-flash', name: 'Gemini Flash', provider: 'Google', tier: 'free', cost: '1 credit' },
  { id: 'gemini-pro', name: 'Gemini Pro', provider: 'Google', tier: 'pro', cost: '4 credits' },
];
...
const CREATOR_STATS = {
  ...
  totalWins: 168,
  winRate: 0.59,
  agents: LEADERBOARD_AGENTS.filter(a => a.creator === 'nyx_dev'),
...
Object.assign(window, {
  ROLE_COLORS, ROLE_ICONS, PHASE_META, GAME_AGENTS, GAME_TIMELINE,
  LEADERBOARD_AGENTS, LOBBY_GAMES, MODELS, CREATOR_STATS, getAgent,
});
